...
const AIChat = () => {
  ...
  return (
    ...
    <div className="max-w-md mx-auto bg-white shadow-lg rounded-xl flex flex-col h-[600px] border border-gray-200 mb-5">

      {/* ===== Header ===== */}
      <div className="flex items-center space-x-3 bg-gradient-to-r from-blue-600 to-blue-400 text-white p-4 rounded-t-xl">
        ...
        <span className="ml-auto bg-green-500 text-white px-3 py-1 rounded-full text-xs font-semibold">
          Online
        </span>
      </div>
        ...
        <div className="flex flex-wrap gap-2">
          {quickQuestions.map((q, i) => (
            <button
              ...
              className="flex items-center px-3 py-1.5 text-xs border border-gray-300 rounded-full hover:bg-blue-50 transition"
            >
              <q.icon className="w-3 h-3 mr-1 text-blue-600" />
              {q.text}
            </button>
          ))}
        </div>
      ...
      <div className="p-4 border-t border-gray-200 bg-white">
        <div className="flex space-x-2">
          ...
          <button
            ...
            className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 cursor-pointer rounded-lg transition disabled:opacity-50 disabled:cursor-not-allowed"
          >
            <Send className="w-4 h-4" />
          </button>
        </div>
        <p className="text-xs font-sans text-red-400 mt-2">
